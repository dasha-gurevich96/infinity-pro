...
function infinity_front_page_widgets() {
	...
	genesis_widget_area( 'front-page-9', array(
		'before' => '<div id="front-page-9" class="front-page-9"><div class="image-section flexible-widgets widget-area fadeup-effect' . infinity_widget_area_class( 'front-page-9' ) . '"><div class="wrap">',
		'after'  => '</div></div></div>',
	) );
	...
	genesis_widget_area( 'front-page-7', array(
		'before' => '<div id="newsletter-sign-up" class="front-page-7"><div class="image-section flexible-widgets widget-area fadeup-effect' . infinity_widget_area_class( 'front-page-7' ) . '"><div class="wrap">',
		'after'  => '</div></div></div>',
	) );
